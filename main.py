...
root = Tk()
root.title("Lilian Initiative System")
...
label = Label(root, text="Lilian Initiative", font=('Arial Bold', 30))
label.grid(row=0, column=0, columnspan=8, rowspan=2, padx=50, pady=40)

studidLabel = Label(root, text="Victim ID", font=('Arial', 15))
...
my_tree['columns'] = ("Victim ID","Firstname","Lastname","Address","Phone")

my_tree.column("#0", width=0, stretch=NO)
my_tree.column("Victim ID", anchor=W, width=170)
...
my_tree.heading("Victim ID", text="Victim ID", anchor=W)
my_tree.heading("Firstname", text="Victim Firstname", anchor=W)
my_tree.heading("Lastname", text="Victim Lastname", anchor=W)
my_tree.heading("Address", text="Victim Address", anchor=W)
my_tree.heading("Phone", text="Victim Phone", anchor=W)
