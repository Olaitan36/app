...
def resource_create(request):
    if request.method == 'POST':
        ...
        form = ResourceForm()
    return render(request, 'users/resource_form.html', {'form': form})
...
def resource_delete(request, resource_id):
    ...
    if request.method == 'POST':
        resource.delete()
        return redirect('resource_list')
    return render(request, 'users/resource_confirm_delete.html', {'resource': resource})

# Donation Views
def donation_list(request):
    donations = Donation.objects.all()
    return render(request, 'users/donation_list.html', {'donations': donations})

def donation_detail(request, donation_id):
    donation = get_object_or_404(Donation, id=donation_id)
    return render(request, 'users/donation_detail.html', {'donation': donation})
...
def donation_create(request):
    if request.method == 'POST':
        ...
        form = DonationForm()
    return render(request, 'users/donation_form.html', {'form': form})
...
def donation_delete(request, donation_id):
    ...
    if request.method == 'POST':
        donation.delete()
        return redirect('donation_list')
    return render(request, 'users/donation_confirm_delete.html', {'donation': donation})
...
def volunteer_create(request):
    if request.method == 'POST':
        ...
        form = VolunteerForm()
    return render(request, 'users/volunteer_form.html', {'form': form})
...
def volunteer_update(request, volunteer_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('users/volunteer_detail', volunteer_id=volunteer.id)
    else:
...
def volunteer_delete(request, volunteer_id):
    ...
    if request.method == 'POST':
        volunteer.delete()
        return redirect('volunteer_list')
    return render(request, 'users/volunteer_confirm_delete.html', {'volunteer': volunteer})
...
def crisis_detail(request, crisis_id):
    ...
    return render(request, 'users/crisis_detail.html', {'crisis': crisis})
...
def crisis_create(request):
    if request.method == 'POST':
        ...
        form = CrisisForm()
    return render(request, 'users/crisis_form.html', {'form': form})
...
def crisis_update(request, crisis_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('users/crisis_detail', crisis_id=crisis.id)
    else:
...
def crisis_delete(request, crisis_id):
    ...
    if request.method == 'POST':
        crisis.delete()
        return redirect('crisis_list')
    return render(request, 'users/crisis_confirm_delete.html', {'crisis': crisis})